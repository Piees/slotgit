...
public class Gui
{
    ...
    public Gui()
    {
        ...
        gbc.gridx = 3;
        gbc.gridy = 0;
        spin3Label.setText("Slots'O'Fun!");
        ...
        gbc.gridx = 3;
        gbc.gridy = 1;
        spin6Label.setText("Slots'O'Fun!");
        ...
        gbc.gridx = 3;
        gbc.gridy = 2;
        spin9Label.setText("Slots'O'Fun!");
